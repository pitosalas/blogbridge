...
//
// $Id: MostPinnedFeedsReport.java,v 1.4 2007/10/03 12:32:29 spyromus Exp $
//
...
/**
 * The report about the feeds in which the user pins the most of articles.
 */
class MostPinnedFeedsReport extends AbstractMostReadPinnedReport
{
    /**
     * Creates a report.
     */
    public MostPinnedFeedsReport()
    {
    ...
    {
        return provider.statGetFeedsPinStats();
    }
    ...
    {
        return Strings.message("report.most.pinned.feeds");
    }
