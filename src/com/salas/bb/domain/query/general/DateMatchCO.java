...
//
// $Id: DateMatchCO.java,v 1.5 2007/02/20 15:15:55 spyromus Exp $
//
...
/**
 * Comparison operation which checks whether the date is within synthetic date range:
 * today, yesterday, last week and etc.
 */
public class DateMatchCO extends DateAbstractCO
{
    /** Instance of this operation. */
    public static final DateMatchCO INSTANCE = new DateMatchCO();
    ...
    public DateMatchCO()
    {
        super(Strings.message("query.operation.is"), "is");
    }
    ...
    {
        return aTimeRange.isInRange(aTargetTimestamp);
    }
}
