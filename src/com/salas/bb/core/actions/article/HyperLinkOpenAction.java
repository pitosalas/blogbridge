...
//
// $Id: HyperLinkOpenAction.java,v 1.9 2006/01/08 04:42:24 kyank Exp $
//
...
/**
 * Opens hovered hyper-link of currently selected article panel in browser.
 */
public final class HyperLinkOpenAction extends AbstractAction
{
    private static HyperLinkOpenAction instance;
    private static URL link;

    /**
     * Hidden singleton constructor.
     */
    private HyperLinkOpenAction()
    {
    }
     ...
     */
    public static synchronized HyperLinkOpenAction getInstance()
    {
        if (instance == null) instance = new HyperLinkOpenAction();
        return instance;
    }
