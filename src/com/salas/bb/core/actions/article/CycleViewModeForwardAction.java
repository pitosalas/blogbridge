...
/**
 * Cycles view mode for feed articles forward.
 */
public class CycleViewModeForwardAction extends AbstractAction
{
    private static CycleViewModeForwardAction instance;

    /**
     * Hidden constructor of singleton class.
     */
    private CycleViewModeForwardAction()
    {
        setEnabled(false);
    }
     ...
     */
    public static synchronized CycleViewModeForwardAction getInstance()
    {
        if (instance == null) instance = new CycleViewModeForwardAction();
        return instance;
    }
