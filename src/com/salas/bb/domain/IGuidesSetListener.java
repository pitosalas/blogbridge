...
//
// $Id: IGuidesSetListener.java,v 1.4 2007/10/04 09:55:08 spyromus Exp $
//

package com.salas.bb.domain;

/**
 * Listener of guides set events.
 */
public interface IGuidesSetListener
{
    /**
     ...
     */
    void guideAdded(GuidesSet set, IGuide guide, boolean lastInBatch);
     ...
     */
    void guideRemoved(GuidesSet set, IGuide guide, int index);
     ...
     */
    void guideMoved(GuidesSet set, IGuide guide, int oldIndex, int newIndex);
}
