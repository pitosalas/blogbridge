...
//
// $Id: LongLessCO.java,v 1.4 2007/02/20 15:15:55 spyromus Exp $
//
...
/**
 * Operation which is comparing two longs. The target should be less than
 * value to get match.
 */
public class LongLessCO extends AbstractComparisonOperation
{
    /** Instance of this comparison operation. */
    public static final LongLessCO INSTANCE = new LongLessCO();
    ...
    public LongLessCO()
    {
        super(Strings.message("query.operation.is.less.than"), "less");
    }
