...
//
// $Id: IFeedListener.java,v 1.2 2006/01/08 04:48:17 kyank Exp $
//
...
public interface IFeedListener
{
     ...
     */
    void articleAdded(IFeed feed, IArticle article);
     ...
     * @param article   article.
     */
    void articleRemoved(IFeed feed, IArticle article);
     ...
     */
    void propertyChanged(IFeed feed, String property, Object oldValue, Object newValue);
}
