...
//
// $Id: StringEqualsCO.java,v 1.5 2007/02/20 15:15:55 spyromus Exp $
//
 ...
 */
public class StringEqualsCO extends AbstractComparisonOperation
{
    /** Instance of this comparison operation. */
    public static final StringEqualsCO INSTANCE = new StringEqualsCO();

    /**
     * Creates operation.
     */
    public StringEqualsCO()
    {
        this(Strings.message("query.operation.is"), "is");
    }
     ...
     */
    protected StringEqualsCO(String name, String descriptor)
    {
    ...
    public boolean match(String targetValue, String comparisonValue)
    {
        ...
        String[] keywords = StringUtils.keywordsToArray(comparisonValue);

        boolean matches = false;
        for (int i = 0; !matches && i < keywords.length; i++)
        {
            matches = targetValue.equalsIgnoreCase(keywords[i]);
        }
