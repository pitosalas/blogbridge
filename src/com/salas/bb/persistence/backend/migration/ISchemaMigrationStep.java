...
//
// $Id: ISchemaMigrationStep.java,v 1.1 2006/07/28 10:39:54 spyromus Exp $
//
...
/**
 * Step in migration chain to update database schema to the next version. Each step is
 * associated with two versions: the version we migrate from and the version we migrate
 * to.
 */
public interface ISchemaMigrationStep
{
     ...
     */
    void perform(Connection connection, HsqlPersistenceManager aManager)
