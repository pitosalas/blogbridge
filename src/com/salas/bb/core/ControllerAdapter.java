...
//
// $Id: ControllerAdapter.java,v 1.10 2006/01/08 04:43:45 kyank Exp $
//
...
/**
 * Default empty implementation of <code>IControllerListener</code> interface for
 * customized overloads.
 */
public class ControllerAdapter implements IControllerListener
{
     ...
     * @param feed    feed.
     */
    public void articleAdded(IArticle article, IFeed feed)
    {
    }
     ...
     * @param feed    feed.
     */
    public void articleRemoved(IArticle article, IFeed feed)
    {
    }
     ...
     */
    public void articleSelected(IArticle article)
    {
    }
