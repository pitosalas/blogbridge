...
//
// $Id: MarkFeedAsUnreadAction.java,v 1.5 2008/02/15 14:25:49 spyromus Exp $
//
...
/**
 * Marks all articles as not read in currently selected channel.
 * <p/>
 * Action is enabled/disabled by <code>ActionsManager</code>.
 */
public class MarkFeedAsUnreadAction extends ThreadedAction
{
    private static MarkFeedAsUnreadAction instance;

    /**
     * Hidden constructor of singleton class.
     */
    protected MarkFeedAsUnreadAction()
    {
        setEnabled(false);
    }
     ...
     * @return instance.
     */
    public static synchronized MarkFeedAsUnreadAction getInstance()
    {
        if (instance == null) instance = new MarkFeedAsUnreadAction();
        return instance;
    }
