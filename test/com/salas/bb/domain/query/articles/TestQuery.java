...
//
// $Id: TestQuery.java,v 1.2 2006/01/08 05:28:16 kyank Exp $
//
...
/**
 * This suite contains tests for <code>Query</code> unit.
 */
public class TestQuery extends TestCase
{
    /**
     * Tests unpersisting missing property.
     */
    public void testUnpersistingMissingProperty()
    {
        Query query = new Query();
        Query.addCriteria(query, "missingproperty", null, null);
        assertEquals("Criteria using missing property should be skipped.",
            0, query.getCriteriaCount());
    }

    /**
     * Tests unpersisting missing comparison operation.
     */
