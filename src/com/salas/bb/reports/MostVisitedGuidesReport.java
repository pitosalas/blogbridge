...
//
// $Id: MostVisitedGuidesReport.java,v 1.5 2007/10/03 12:32:29 spyromus Exp $
//
...
/**
 * Most visited guides report.
 */
class MostVisitedGuidesReport extends AbstractMostVisitedReport
{
    /**
     * Creates a report.
     */
    public MostVisitedGuidesReport()
    {
    ...
    {
        return Strings.message("report.most.visited.guides");
    }
    ...
    {
        visitStats = provider.statGetMostVisitedGuides(Integer.MAX_VALUE);
    }
