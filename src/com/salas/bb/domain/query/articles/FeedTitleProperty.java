...
//
// $Id: FeedTitleProperty.java,v 1.8 2007/02/20 15:15:55 spyromus Exp $
//
...
/**
 * Feed title property of <code>IArticle</code> objects.
 */
public class FeedTitleProperty extends AbstractProperty
{
    /** Instance of this property. */
    public static final FeedTitleProperty INSTANCE = new FeedTitleProperty();

    /**
     * Creates property.
     */
    protected FeedTitleProperty()
    {
        super(Strings.message("query.property.feed.title"), "feed-title", PropertyType.STRING, "",
