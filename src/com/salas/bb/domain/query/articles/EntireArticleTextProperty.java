...
//
// $Id: EntireArticleTextProperty.java,v 1.1 2007/04/03 13:10:24 spyromus Exp $
//
 ...
 */
public class EntireArticleTextProperty extends ArticleTextProperty
{
    /** Instance of this property. */
    public static final EntireArticleTextProperty INSTANCE = new EntireArticleTextProperty();

    /**
     * Creates property.
     */
    protected EntireArticleTextProperty()
    {
        super(Strings.message("query.property.article.entire"), "article-entire");
    }
