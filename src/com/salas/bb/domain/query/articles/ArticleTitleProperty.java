...
//
// $Id: ArticleTitleProperty.java,v 1.3 2007/02/20 15:15:55 spyromus Exp $
//
...
/**
 * Artoc;e title property of <code>IArticle</code> objects.
 */
public class ArticleTitleProperty extends AbstractProperty
{
    /** Instance of this property. */
    public static final ArticleTitleProperty INSTANCE = new ArticleTitleProperty();

    /**
     * Creates property.
     */
    protected ArticleTitleProperty()
    {
        super(Strings.message("query.property.article.title"), "article-title", PropertyType.STRING, "",
