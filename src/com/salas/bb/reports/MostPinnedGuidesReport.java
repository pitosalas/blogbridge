...
//
// $Id: MostPinnedGuidesReport.java,v 1.4 2007/10/03 12:32:29 spyromus Exp $
//
...
/**
 * The report about the guides in which the user pins the most of articles.
 */
class MostPinnedGuidesReport extends AbstractMostReadPinnedReport
{
    /**
     * Creates a report.
     */
    public MostPinnedGuidesReport()
    {
    ...
    {
        return provider.statGetGuidesPinStats();
    }
    ...
    {
        return Strings.message("report.most.pinned.guides");
    }
