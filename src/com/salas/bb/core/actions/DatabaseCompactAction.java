...
//
// $Id: DatabaseCompactAction.java,v 1.1 2007/03/30 10:05:24 spyromus Exp $
//
 ...
 */
public class DatabaseCompactAction extends ThreadedAction
{
    private static final DatabaseCompactAction INSTANCE = new DatabaseCompactAction();
    private static final Logger LOG = Logger.getLogger(DatabaseCompactAction.class.getName());

    /**
     * Creates action.
     */
    private DatabaseCompactAction()
    {
        setEnabled(false);
    }
     ...
     * @return instance.
     */
    public static DatabaseCompactAction getInstance()
    {
        return INSTANCE;
    }
