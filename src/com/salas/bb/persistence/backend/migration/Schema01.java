...
/**
 * Migration from 3.0 to 3.01.
 */
public class Schema01 extends AbstractSchema
{
    /**
    ...
    {
        addColumn(con, "FEEDS2GUIDES", "POSITN INTEGER DEFAULT '0' NOT NULL");
        addColumn(con, "FEEDS2READINGLISTS", "POSITN INTEGER DEFAULT '0' NOT NULL");
    }
}
